...
public class EasybRewriter extends StatementReplacingVisitorSupport {
  ...
  private void insertNormalizedSource(String normalizedText, MethodCallExpression call) {
    ...
    if (e instanceof ArgumentListExpression ) {
      ...
      ale = (ArgumentListExpression) call.getArguments();
    }
  }

  private final List<String> easybMethods = Arrays.asList("scenario", "given", "then", "when", "and", "before", "before_each", "after", "after_each", "examples", "where", "but", "narrative");
