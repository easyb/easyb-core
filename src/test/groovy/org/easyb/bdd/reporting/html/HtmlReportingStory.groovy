...
scenario "a passing, failing and pending specification", {
    given "a specification file with passing, failing and pending specifications is loaded", {
        storyBehavior = BehaviorFactory.createBehavior(new File("${testSourceDir}/groovy/org/easyb/bdd/reporting/html/PassingPendingFailing.specification"))
    }
...
scenario "a passing, failing and pending scenario", {
    given "a story file with a passing, failing and pending scenario is loaded", {
        storyBehavior = BehaviorFactory.createBehavior(new File("${testSourceDir}/groovy/org/easyb/bdd/reporting/html/PassingPendingFailingStory.story"))
    }
